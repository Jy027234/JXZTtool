...
def _continuity_schema() -> dict[str, Any]:
    return {
        ...
        "properties": {
            ...
            "continues_from_unit_id": _string_schema(),
            "continues_to_unit_id": _string_schema(),
...
def _source_span_schema() -> dict[str, Any]:
    return {
        "type": "object",
        "required": [
            "page_start",
        ...
        "properties": {
            ...
            "bbox": _bbox_schema(),
            "bbox_page": _integer_schema(nullable=True),
            "precision": {"enum": ["region", "page"]},
            "degraded_reason": _string_schema(),
        },
        "additionalProperties": False,
    }


def _source_integrity_schema() -> dict[str, Any]:
    return {
        "type": "object",
        "required": [
            "status",
        ...
        "properties": {
            ...
            "hash_algorithm": _string_schema(),
            "source_hash": _string_schema(),
            "source_size_bytes": _integer_schema(),
            "source_mtime_ns": _integer_schema(),
            "parser_schema_version": _string_schema(),
            "parser_config_fingerprint": _string_schema(),
            "provider_fingerprint": _string_schema(),
        },
        "additionalProperties": False,
    }


def _knowledge_unit_diff_ref_schema() -> dict[str, Any]:
    return {
        "type": ["object", "null"],
        "required": [
            "unit_id",
        ...
        "properties": {
            ...
            "stable_unit_id": _string_schema(),
            "unit_fingerprint": _string_schema(),
            "content_fingerprint": _string_schema(),
            "structure_fingerprint": _string_schema(),
            "page_span": _page_span_schema(),
            "section_no": _string_schema(),
            "title_path": _string_list_schema(),
        },
        "additionalProperties": False,
    }


def _knowledge_unit_diff_schema() -> dict[str, Any]:
    return {
        "type": "object",
        "required": [
            "schema_version",
        ...
        "properties": {
            ...
            "algorithm_version": _string_schema(),
            "previous_parse_run_id": _string_schema(),
            "current_parse_run_id": _string_schema(),
            "baseline": _boolean_schema(),
            "complete": _boolean_schema(),
            "counts": {
                "type": "object",
                "required": ["unchanged", "added", "changed", "removed", "relocated", "unknown"],
                "properties": {
                    status: _integer_schema()
                    for status in ("unchanged", "added", "changed", "removed", "relocated", "unknown")
                },
                "additionalProperties": False,
            },
            "mappings": {
                ...
                "items": {
                    "type": "object",
                    "required": ["status", "reason", "confidence", "previous", "current"],
                    "properties": {
                        "status": _string_schema(),
                        "reason": _string_schema(),
                        "confidence": _number_schema(),
                        "previous": _knowledge_unit_diff_ref_schema(),
                        "current": _knowledge_unit_diff_ref_schema(),
                    },
                    "additionalProperties": False,
                },
            },
...
def _coverage_unit_schema() -> dict[str, Any]:
    return {
        ...
        "properties": {
            "unit_id": _string_schema(),
            "stable_unit_id": _string_schema(),
            "unit_contract_version": _string_schema(),
            "unit_fingerprint": _string_schema(),
            "content_fingerprint": _string_schema(),
            "structure_fingerprint": _string_schema(),
            "source_version_key": _string_schema(),
            "source_span": _source_span_schema(),
            "list_level": _integer_schema(),
            "list_marker": _string_schema(),
            "list_parent_unit_id": _string_schema(),
            "continuity_required": _boolean_schema(),
            ...
            "parent_section_id": _string_schema(),
            "section_no": _string_schema(),
            "section_title": _string_schema(),
            "section_level": _integer_schema(),
            "title_path": _string_list_schema(),
            "continuity": _continuity_schema(),
            ...
            "processing_status": _string_schema(),
            "processing_reason": _string_schema(),
            "missing_reason": _string_schema(nullable=True),
            "quality_signal_codes": _string_list_schema(),
        },
        "additionalProperties": False,
...
def _coverage_summary_schema() -> dict[str, Any]:
    return {
        ...
        "properties": {
            ...
            "accounted_unit_count": _integer_schema(),
            "unaccounted_unit_count": _integer_schema(),
            "processing_status_counts": {
                "type": "object",
                "required": ["pending", "processed", "skipped", "failed", "reviewed"],
                "properties": {
                    "pending": _integer_schema(),
                    "processed": _integer_schema(),
                    "skipped": _integer_schema(),
                    "failed": _integer_schema(),
                    "reviewed": _integer_schema(),
                },
                "additionalProperties": False,
            },
...
def _ir_block_schema() -> dict[str, Any]:
    return {
        ...
        "properties": {
            ...
            "stable_block_id": _string_schema(),
            "block_fingerprint": _string_schema(),
            "source_version_key": _string_schema(),
            "page_number": _integer_schema(),
            "page_span": _page_span_schema(),
            "type": _string_schema(),
            "semantic_role": _string_schema(),
            "is_section_heading": _boolean_schema(),
            "heading_level": _integer_schema(nullable=True),
            "normalized_title": _string_schema(),
            "section_no": _string_schema(),
            "list_level": _integer_schema(),
            "list_marker": _string_schema(),
            "list_parent_block_id": _string_schema(),
            "text": _string_schema(),
            "bbox": _bbox_schema(),
            ...
            "quality_flags": _string_list_schema(),
            "continuation": _generic_object_schema(),
            "source_span": _source_span_schema(),
...
def _ir_table_schema() -> dict[str, Any]:
    return {
        ...
        "properties": {
            ...
            "stable_table_id": _string_schema(),
            "table_fingerprint": _string_schema(),
            "source_version_key": _string_schema(),
...
def _ir_figure_schema() -> dict[str, Any]:
    return {
        ...
        "properties": {
            ...
            "stable_figure_id": _string_schema(),
            "figure_fingerprint": _string_schema(),
            "source_version_key": _string_schema(),
            "block_id": _string_schema(),
            "page_number": _integer_schema(),
            "page_span": _page_span_schema(),
...
def _coverage_document_schema() -> dict[str, Any]:
    return {
        ...
        "properties": {
            ...
            "source_integrity": _source_integrity_schema(),
            "knowledge_unit_diff": _knowledge_unit_diff_schema(),
